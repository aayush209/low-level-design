...
import onlineshoppingsystemlikeamazon.payment.CreditCardPayment;
...
public class OnlineShoppingServiceDemo {
    ...
    public static void main(String[] args) {
        ...
        cart1.addProductToCart(product1, 2);
        cart1.addProductToCart(product2, 1);
        ...
        cart2.addProductToCart(searchResults.get(0), 1);
